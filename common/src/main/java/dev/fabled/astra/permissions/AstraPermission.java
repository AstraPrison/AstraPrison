...
public enum AstraPermission {
    ...
    ASTRA_STAR(
            ...
            "astra.admin.*", "astra.mines.*", "astra.omnitool.*"
    ),

    ADMIN_STAR(
            "astra.admin.*",
            "Gives all Astra admin permissions",
            "astra.admin", "astra.admin.help", "astra.admin.reload", "astra.admin.menu.other"
    ),

    ADMIN("astra.admin", "Permission for /astra"),
    ADMIN_HELP("astra.admin.help", "Permission for /astra help"),
    ADMIN_RELOAD("astra.admin.reload", "Permission for /astra reload"),
    ADMIN_MENU("astra.admin.menu", "Permission for /astra menu"),
    ADMIN_MENU_OTHER(
    ...
    OMNI_TOOL_STAR(
            ...
            "astra.omnitool", "astra.omnitool.give"
    ),
    OMNI_TOOL("astra.omnitool", "Permission for /omnitool"),
    OMNI_TOOL_GIVE("astra.omnitool.give", "Permission for /omnitool give"),
    ...
    MINE_WAND_STAR(
            ...
            "astra.mines.wand", "astra.mines.wand.give", "astra.mines.wand.use"
    ),
    MINE_WAND("astra.mines.wand", "Permission for /minewand"),
    MINE_WAND_OTHER("astra.mines.wand.other", "Permission for /minewand <player>"),
