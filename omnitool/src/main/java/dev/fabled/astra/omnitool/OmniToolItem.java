...
public class OmniToolItem {
    ...
    public static final NamespacedKey LEVEL_KEY = new NamespacedKey(Astra.getPlugin(), "level");
    public static final NamespacedKey BLOCKS_KEY = new NamespacedKey(Astra.getPlugin(), "brokenBlocks");
    public static final NamespacedKey LEVEL_BLOCKS_KEY = new NamespacedKey(Astra.getPlugin(), "levelBlocks");
